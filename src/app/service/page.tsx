...
export default function Services() {
  ...
  return (
    <section className=" py-20 pt-32 px-4 md:px-8 lg:px-20 bg-background relative overflow-hidden">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {items.map((service, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${service.color} rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-xl`}
                ></div>

                <div
                  className={`relative p-8 rounded-lg bg-card border ${service.borderColor} hover:border-primary/50 transition-all duration-300 hover:shadow-xl hover:shadow-primary/10 group-hover:scale-105 group-hover:-translate-y-1`}
                >
